...
const mutelog = message.guild.channels.cache.find(c => c.id === '800615883566350376')//Mute logu
const muterol = message.guild.roles.cache.find(r => r.id === '800615766797189140')//Muteli rolü
